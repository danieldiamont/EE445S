...
In this particular case we notice that the in-phase and quadrature component are orthoganal,
...
In QAM it is important that the carriers are orthoganl to each other, so any phase errors between
